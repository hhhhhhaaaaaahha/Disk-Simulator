...
void record_write_virtual_tracks(struct disk *d, long tracks, long num_phy_tracks);
void record_delete(struct disk *d, b_table_head_t *table);
void record_delete_physical_tracks(struct disk *d, long tracks);
void record_delete_virtual_tracks(struct disk *d, long tracks, long num_phy_tracks);